...
//    public static final Item COCONUT_SLICE = new Item(new FabricItemSettings().maxCount(16));
    ...
    public void onInitialize() {
        ...
        Registry.register(Registries.ITEM, new Identifier(tropica, "black_mangrove_button"), new BlockItem(BLACK_MANGROVE_BUTTON, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "black_mangrove_fence_gate"), new BlockItem(BLACK_MANGROVE_FENCE_GATE, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "black_mangrove_fence"), new BlockItem(BLACK_MANGROVE_FENCE, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "black_mangrove_sign"), new BlockItem(BLACK_MANGROVE_SIGN_BLOCK, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "black_mangrove_hanging_sign"), new BlockItem(BLACK_MANGROVE_HANGING_SIGN_BLOCK, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "black_mangrove_planks"), new BlockItem(BLACK_MANGROVE_PLANKS, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "black_mangrove_knees"), new BlockItem(BLACK_MANGROVE_KNEES, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "black_mangrove_leaves"), new BlockItem(BLACK_MANGROVE_LEAVES, new FabricItemSettings().maxCount(64)));
        ...
        Registry.register(Registries.ITEM, new Identifier(tropica, "stripped_black_mangrove_log"), new BlockItem(STRIPPED_BLACK_MANGROVE_LOG, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "stripped_black_mangrove_wood"), new BlockItem(STRIPPED_BLACK_MANGROVE_WOOD, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "black_mangrove_hanging_propagule"), new BlockItem(BLACK_MANGROVE_HANGING_PROPAGULE, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "black_mangrove_propagule"), new BlockItem(BLACK_MANGROVE_PROPAGULE_BLOCK, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "black_mangrove_trapdoor"), new BlockItem(BLACK_MANGROVE_TRAPDOOR, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "brown_coconut_block"), new BlockItem(BROWN_COCONUT_BLOCK, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "yellow_coconut_block"), new BlockItem(YELLOW_COCONUT_BLOCK, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "green_coconut_block"), new BlockItem(GREEN_COCONUT_BLOCK, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_berry"), new BlockItem(COCONUT_BERRY, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_door"), new BlockItem(COCONUT_DOOR, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_pressure_plate"), new BlockItem(COCONUT_PRESSURE_PLATE, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_button"), new BlockItem(COCONUT_BUTTON, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_fence_gate"), new BlockItem(COCONUT_FENCE_GATE, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_fence"), new BlockItem(COCONUT_FENCE, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_sign_block"), new BlockItem(COCONUT_SIGN_BLOCK, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_hanging_sign"), new BlockItem(COCONUT_HANGING_SIGN_BLOCK, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_planks"), new BlockItem(COCONUT_PLANKS, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_leaves"), new BlockItem(COCONUT_LEAVES, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_log"), new BlockItem(COCONUT_LOG, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_wood"), new BlockItem(COCONUT_WOOD, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "stripped_coconut_log"), new BlockItem(STRIPPED_COCONUT_LOG, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "stripped_coconut_wood"), new BlockItem(STRIPPED_COCONUT_WOOD, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_sheath"), new BlockItem(COCONUT_SHEATH, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_sheath_wood"), new BlockItem(COCONUT_SHEATH_WOOD, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_shoot"), new BlockItem(COCONUT_SHOOT, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_trapdoor"), new BlockItem(COCONUT_TRAPDOOR, new FabricItemSettings().maxCount(64)));
        Registry.register(Registries.ITEM, new Identifier(tropica, "coconut_tuft"), new BlockItem(COCONUT_TUFT, new FabricItemSettings().maxCount(64)));
